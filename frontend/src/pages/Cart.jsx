    ...
    <div className="flex flex-col md:flex-row mt-16">
      <div className="flex-1 max-w-4xl">
        <h1 className="text-3xl font-medium mb-6">
          Shopping Cart{" "}
          <span className="text-sm text-emerald-500">{getCartCount()} Items</span>
        </h1>
      ...
      <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
            ...
            {showAddress && (
              <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                ...
                <p
                  ...
                  className="text-emerald-500 text-center cursor-pointer p-2 hover:bg-indigo-500/10"
                >
                  Add address
                </p>
              </div>
        ...
        <button
          onClick={placeOrder}
          className="w-full py-3 mt-6 cursor-pointer bg-emerald-500 text-white font-medium hover:bg-emerald-600 transition"
        >
