...
const MyOrders = () => {
    ...
    const fetchMyOrders = async() => {
        try{
            const { data } = await axios.post("/api/order/user", { userId: user._id }, { withCredentials: true });
  ...
  return (
    <div className='mt-16 pb-16'>
        <div className='flex flex-col w-max items-end mb-8'>
            <p className='text-2xl font-medium uppercase'> My orders </p>
            <div className='w-6 h-0.5 rounded-full bg-emerald-400'></div>
        </div>
